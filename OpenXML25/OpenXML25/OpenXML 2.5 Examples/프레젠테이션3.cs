...
namespace GeneratedCode
{
    public class GeneratedClass3
    {
        ...
        private void GenerateSlidePart1Content(SlidePart slidePart1)
        {
            ...
            NonVisualDrawingProperties nonVisualDrawingProperties2 = new NonVisualDrawingProperties(){ Id = (UInt32Value)2U, Name = "직사각형 1" };
            ...
            A.Offset offset2 = new A.Offset(){ X = 1172584L, Y = 1075765L };
            A.Extents extents2 = new A.Extents(){ Cx = 9165515L, Cy = 4518211L };
        ...
        private void GenerateSlideLayoutPart3Content(SlideLayoutPart slideLayoutPart3)
        {
            ...
            paragraph25.Append(paragraphProperties13);
        ...
        private void GenerateViewPropertiesPart1Content(ViewPropertiesPart viewPropertiesPart1)
        {
            ...
            RestoredLeft restoredLeft1 = new RestoredLeft(){ Size = 17051, AutoAdjust = false };
            RestoredTop restoredTop1 = new RestoredTop(){ Size = 95220, AutoAdjust = false };
            ...
            Origin origin1 = new Origin(){ X = 82L, Y = 288L };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2015-03-27T14:32:33Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "goodhobak";
        }

        #region Binary Data
        private string thumbnailPart1Data = "";
